    ...
    >
      <div class="overflow-x-auto">
        <table class="glass-table">
          ...
          <tbody>
            ...
            >
              <td class="font-mono text-xs text-white/50">
                #{{ order.id.slice(0, 8) }}
              </td>
              ...
              <td class="font-bold text-cyan-300">
                ¥{{ (order.totalPrice.amountFen / 100).toFixed(2) }}
              </td>
              <td class="text-sm text-white/40">
      ...
      <div class="flex justify-between items-center px-6 py-4 text-sm border-t border-white/5 text-white/50">
        ...
        <div class="flex gap-2">
          <button class="px-3 py-1 rounded hover:bg-white/10 disabled:opacity-50">
            上一页
          </button>
          <button class="px-3 py-1 text-white rounded bg-white/10">
            1
          </button>
